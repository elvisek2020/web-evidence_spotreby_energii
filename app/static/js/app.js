...
function showToast(message, type = 'info', duration = 5000) {
    ...
    toast.innerHTML = `
        <div class="max-w-sm w-full ${colors[type]} border rounded-lg p-4 shadow-lg" role="alert">
            <div class="flex">
                ...
                <div class="ml-auto pl-3">
                    <div class="-mx-1.5 -my-1.5">
                        <button onclick="closeToast('${toastId}')" class="inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-50 focus:ring-blue-600">
